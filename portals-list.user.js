// ==UserScript==
// @id             iitc-plugin-portals-list@teo96 edit by takurua/yuehuTi
// @name           IITC plugin: show list of portals
// @category       Info
// @version        0.2.1.20210217.234100
// @namespace      https://github.com/jonatkins/ingress-intel-total-conversion
// @updateURL      https://github.com/yuehuTi/iitc-portal-list/raw/main/portals-list.meta.js
// @downloadURL    https://github.com/yuehuTi/iitc-portal-list/raw/main/portals-list.user.js
...
window.plugin.portalslist.fields = [
  ...
  },
  {
    ...
    value: function(portal) {
      ...
      return type&2?2:type&1;
    },
    format: function(cell, portal, value) {
      var text = value==2?"C":(value==1?"V":"N")
      $(cell)
        .addClass("alignR")
        .text(text);
    },
  ...
  },
  {
    title: "Inactive",
    value: function(portal) { 
      var date = new Date(portal.options.timestamp);
...
window.plugin.portalslist.getPortals = function() {
  ...
  $.each(window.portals, function(i, portal) {
    ...
    if (Object.keys(portal.options.data).length < 13) return true;
